...
function paintForm($positionCharacter) {
    $output = '';
    $output .= '<form action="'.$_SERVER['PHP_SELF'].'" method="post">';
    $output .= '<input type="submit" name="direccion" value="arriba">';
    $output .= '<input type="submit" name="direccion" value="abajo">';
    $output .= '<input type="submit" name="direccion" value="izquierda">';
    $output .= '<input type="submit" name="direccion" value="derecha">';
    if (isset($positionCharacter)) {
        $output .= '<input type="hidden" name="pos_personaje" value="'.base64_encode(serialize($positionCharacter)).'">';
    }
    $output .= '</form>';
    return $output;
}
...
$positionCharacter = processInput();
$tableMarkup = getTableMarkup($table, $positionCharacter);
$formMarkup = paintForm($positionCharacter);
