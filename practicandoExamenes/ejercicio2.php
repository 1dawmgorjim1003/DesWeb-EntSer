    ...
    foreach($table as $rowIndex => $rowData) {
        ...
        foreach($rowData as $colIndex => $colData) {
            ...
            if (isset($positionCharacter)) {
                //Si el valor de I y el valor de J son iguales a sus valores I y J, se pinta el personaje
                if ($rowIndex == $positionCharacter['row'] && $colIndex == $positionCharacter['col']) {
...
function getMessagesMarkup($positionCharacter, $messages) {
    ...
    if ($positionCharacter == null) {
        ...
        if ($positionCharacter['row'] >= 0 && $positionCharacter['row'] < 13 && $positionCharacter['col'] >= 0 && $positionCharacter['col'] < 13 ) {
